        ...
        <ProtectedRoute>
            <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    {settings?.houses_finalized && (
                        <div className="mb-6 p-6 bg-gray-100 border-2 border-gray-300 rounded-lg">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-gray-900">Houses Have Been Finalized</h3>
                                    <p className="text-gray-700">House proposals are no longer being accepted. The houses have been finalized by the admin.</p>
                                </div>
                            </div>
                        </div>
                    )}

                    {settings && !settings.houses_finalized && !settings.house_proposals_open && (
                        <div className="mb-6 p-6 bg-yellow-50 border-2 border-yellow-300 rounded-lg">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-yellow-900">House Proposals Currently Closed</h3>
                                    <p className="text-yellow-800">House proposals are temporarily closed. Please wait for the admin to open them.</p>
                                </div>
                            </div>
                        </div>
                    )}
                    ...
                    {/* New Proposal Button */}
                    {!showForm && settings?.house_proposals_open && !settings.houses_finalized && (
                        <button
